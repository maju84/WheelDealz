...
/* our CustomWebAppFactory will use this class to re/initialize the database
 * between the tests so that each test has a clean database to work with
 */
public static class DbHelper
{
    ...
    private static List<Auction> GetAuctionsForTest(){  // todo reuse DbInitializer.SeedData instead of copy and paste?
